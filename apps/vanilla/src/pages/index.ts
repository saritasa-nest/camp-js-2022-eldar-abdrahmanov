...
/** Creates and initializes a pagination cell array. Return array of HTMLelements
 ...
 *  */
function renderPage(url: string, paginationLength: number, paginationStartIndex: number) {
  getPagination(url)
    .then((res: Pagination) => {
      currentPagination = res;
